...
{
    private readonly CompanyDataAggregateCosmosModel CompanyDataAggregateCosmosModel;

    public VehicleSSCEvaluator(CompanyDataAggregateCosmosModel companyDataAggregateCosmosModel)
    {
