...
/// <see cref="VehicleSaleInformation.Intermediaries"/> is a list. Like the distributor, an intermediary never
/// makes the end-customer sale (see <see cref="LookupOptions.IsEndCustomerSaleCompany"/>); this block is
