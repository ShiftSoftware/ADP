    ...
    where TCosmos : class
{
        ...
        )
    {
        ...
        var shutDownTime = operationStart.AddSeconds(operationTimeoutInSeconds);
        ...
        while (currentStep < totalSteps)
        {
            ...
            var remainingTimeToShutdown = shutDownTime - DateTime.UtcNow;
