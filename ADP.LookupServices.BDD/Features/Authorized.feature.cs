...
namespace LookupServices.BDD.Features
{
    ...
    public partial class AuthorizedVehiclesFeature : object, Xunit.IClassFixture<AuthorizedVehiclesFeature.FixtureData>, Xunit.IAsyncLifetime
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Authorized Vehicles", @"Authorized & Unauthorized Cars
