...
| BlockedNotAllocated | Activation is due but cannot be offered — the vehicle is not allocated to the requesting company (no vehicle entry for it). Surfaced as a non-actionable warning. |
