...
| Distributor <div><strong>``VehicleDistributorSaleInformation``</strong></div> | The [distributor leg](/generated/LookupServices/DTOsAndModels/VehicleLookup/VehicleDistributorSaleInformation.html) of the supply chain, when the
...
| Intermediaries <div><strong>``List<VehicleIntermediarySaleInformation>``</strong></div> | The [intermediary legs](/generated/LookupServices/DTOsAndModels/VehicleLookup/VehicleIntermediarySaleInformation.html) (0..n) the vehicle passed
