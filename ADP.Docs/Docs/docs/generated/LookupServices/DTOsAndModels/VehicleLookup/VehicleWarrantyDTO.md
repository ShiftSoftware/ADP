...
| HasExtendedWarranty <div><strong>``bool``</strong></div> | Whether the vehicle has one or more extended-warranty coverages. This remains true for historical coverage whose end date has passed. |
...
| ExtendedWarranties <div><strong>``List<VehicleExtendedWarrantyDTO>``</strong></div> | The individual extended-warranty coverages awarded to the vehicle. The legacy flat extended-warranty fields remain an aggregate compatibility summary of this collection. |
