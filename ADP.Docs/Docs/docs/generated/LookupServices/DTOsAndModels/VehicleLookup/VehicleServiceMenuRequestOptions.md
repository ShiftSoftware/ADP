...
| FreeFilter <div><strong>``ServiceMenuFreeFilter``</strong></div> | Which of the model's variants to include, by their free-of-charge flag: all of them (the default), only the free ones, or only the ones that are not free. See [ServiceMenuFreeFilter](/generated/LookupServices/DTOsAndModels/ServiceMenu/ServiceMenuFreeFilter.html). |
