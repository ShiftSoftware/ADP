...
| BrandIDs <div><strong>``IEnumerable<long?>``</strong></div> | The brand IDs this coverage is awarded for. Omit it to award every brand, which is what every definition did before this property existed; an empty list awards none. |
