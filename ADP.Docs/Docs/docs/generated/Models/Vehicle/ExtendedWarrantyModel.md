...
| IsActive <div><strong>``bool``</strong></div> | Extended Warranty Entries may go through a long approval process until considered active. Or they may be revoked after issuing. The status is calculated outside and it's simply passed to ADP as a boolean. |
