...
| CampaignVinEntryID <div><strong>``string``</strong></div> | The ID of the [Campaign VIN Entry](/generated/Models/Vehicle/CampaignVinEntryModel.html) associated with this claim, if any. Set when the claimed item was activated by a manual per-VIN entry (ManualVinEntry trigger). |
