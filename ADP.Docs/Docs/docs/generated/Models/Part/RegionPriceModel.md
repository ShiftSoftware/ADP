...
| RetailUnitPrices <div><strong>``IEnumerable<PartUnitPriceModel>``</strong></div> | The retail price of the part in the region broken down by selling unit (e.g. each, box).
 ...
 a violation throws an [InvalidOperationException](/generated/System/InvalidOperationException.html). |
