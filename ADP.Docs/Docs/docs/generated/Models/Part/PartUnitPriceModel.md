...
| IsDefault <div><strong>``bool``</strong></div> | Indicates whether this unit price is the default retail unit price. Only one unit price within the list may be marked as the default. |
