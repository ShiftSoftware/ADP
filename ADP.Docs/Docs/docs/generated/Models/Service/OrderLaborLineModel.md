...
| JobDescription <div><strong>``string``</strong></div> | A general description of the parent order/job associated with this labor line. |
...
| LaborCode <div><strong>``string``</strong></div> | The unique Labor/Operation Code. Typically from the Manufacturer's Service Catalog. |
| ServiceCode <div><strong>``string``</strong></div> | The service code associated with this line. Typically a distributor level code. |
| ServiceDescription <div><strong>``string``</strong></div> | The description associated with this line. Typically a free text or a distributor/dealer level description of the labor operation performed. |
