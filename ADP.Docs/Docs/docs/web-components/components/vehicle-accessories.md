...
The `<vehicle-accessories>` component displays accessories installed on a vehicle, including part numbers and descriptions.
...
<div markdown="0">
  ...
  <p style="margin-bottom:8px">
    ...
    <button onclick="document.getElementById('demo-vehicle-accessories').fetchVin('JTMHX01J8L4198293')" style="cursor:pointer;padding:4px 12px;margin:4px;border:1px solid #ccc;border-radius:4px;background:#f5f5f5">JTMHX01J8L4198293</button>
    <button onclick="document.getElementById('demo-vehicle-accessories').fetchVin('JTMW43FV10D123456')" style="cursor:pointer;padding:4px 12px;margin:4px;border:1px solid #ccc;border-radius:4px;background:#f5f5f5">JTMW43FV10D123456</button>
  </p>

  <vehicle-accessories id="demo-vehicle-accessories" language="en"></vehicle-accessories>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      fetch('../demo-data/standard-dealer/vehicle-lookup.json')
        ...
        .then(function (mockData) {
          var el = document.getElementById('demo-vehicle-accessories');
          el.isDev = true;
