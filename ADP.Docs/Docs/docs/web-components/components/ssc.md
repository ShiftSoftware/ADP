...
<div markdown="0">
  ...
  <p style="margin-bottom:8px">
    ...
    <button onclick="document.getElementById('demo-ssc').fetchVin('ZT8P9NAL1LG988010')" style="cursor:pointer;padding:4px 12px;margin:4px;border:1px solid #ccc;border-radius:4px;background:#f5f5f5">ZT8P9NAL1LG988010</button>
