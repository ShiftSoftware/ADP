...
Background:
	...
	And the following vehicles in their dealer stock (coming from their DMS):
		| VIN               |
		| 1FDKF37GXVEB34368 |
		| 1FTFW1EFXEKD12345 |

	And the following vehicles in official SSC Vehciles (Provided by the vehicle manufacturer):
		| VIN               |
		| 1G1ZC5E17BF283048 |
