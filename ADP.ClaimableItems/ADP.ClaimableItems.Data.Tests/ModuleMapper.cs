...
/// <summary>
/// The module's maps, resolved the way a host resolves them: <c>AddClaimableItemsApiServices</c> hands the Data
/// assembly to <c>RegisterShiftRepositories</c>, which registers that assembly's generated ShiftMapper mapper - the
/// repositories' automatic maps and <c>Mappers/ClaimableItemsMapper.cs</c> - and a repository maps through it behind
