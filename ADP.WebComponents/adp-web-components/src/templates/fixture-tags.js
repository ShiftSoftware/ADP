...
export const FIXTURE_TAGS = {
  'vehicle-specification': {
    ...
    ZW8UWF8J4TJ368365: 'six details · paint: metallic, with the finish highlight',
    ...
    ZS8QK3WR5TD881204: 'the two model years disagree · paint: pearl',
    ZS8Z4RNS9TC073619: 'year from the record only · paint: solid, flat chip',

    /* broker-market — realistic volume, and the only place the name precedence shows. */
    ZT8APGED9RB475247: 'the distributor’s own paint name, beside the table’s chip',
    ...
    ZT8LY7CZ0S2959088: 'identity only · the environment’s typical vehicle',
    ZS8WJEXK206451985: 'authorized, empty record · no records',
    ZV9LMW6D75T151181: 'not in distributor records',

    /* standard-dealer */
    ZT8P9NAL1LG988010: 'no year, no model code · paint: metallic',
    JTMW43FV10D123456: 'paint: pearl · a chip the table has a hex for',
    UNKNOWN_VIN_12345: 'not in distributor records',

    /* broker-dealer — four real paint codes, one per finish the table carries. */
    JTMHF33P5D5012345: 'paint: metallic',
    JTEBU5JR8L5234567: 'paint: pearl',
    JTEHF21A0Y0123456: 'paint: solid',
    JTLBR3JR9N5345678: 'paint: a fourth real code',
  },
};
