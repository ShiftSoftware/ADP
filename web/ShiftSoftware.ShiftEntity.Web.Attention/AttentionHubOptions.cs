...
public sealed class AttentionHubOptions
{
	...
	/// JWT as the <c>access_token</c> query parameter. For requests under <see cref="P:ShiftSoftware.ShiftEntity.Web.Attention.AttentionHubOptions.HubPath" />,
	...
	/// <see cref="F:ShiftSoftware.ShiftEntity.Core.Attention.AttentionRealtime.DefaultHubRoute" />. If the hub is mapped at a custom
	/// route, keep this value equal to the pattern passed to <c>MapAttentionHub</c>.
	/// </summary>
	public string HubPath { get; set; } = "/hubs/attention";
}
