...
/// <summary>
/// Framework-agnostic result from <see cref="T:ShiftSoftware.ShiftEntity.Web.ShiftEntityCrudHandler`4" />.
...
public class CrudResult
{
	...
	/// <summary>The response body to serialize (usually a <see cref="T:ShiftSoftware.ShiftEntity.Model.ShiftEntityResponse`1" />).</summary>
	...
	/// When set, <see cref="P:ShiftSoftware.ShiftEntity.Web.CrudResult.Body" /> is ignored.
	/// </summary>
	...
	public static CrudResult Ok(object? body)
	{
	...
	public static CrudResult BadRequest(object? body)
	{
		return new CrudResult
		{
			StatusCode = 400,
	...
	public static CrudResult NotFound(object? body)
	{
		return new CrudResult
		{
			StatusCode = 404,
